  ...
  return (
    <div className="flex relative">
      <input
        {...props}
        type={hidePassword}
        className={` hover:border-primary border  border-slate-800 focus:bg-mirage-900/60 from-mirage-300/20 to-mirage-400/20 bg-linear-to-br not-last-of-type:text-lg transition-colors duration-150 px-3 rounded outline-1 outline-slate-900 focus:outline-2  focus:outline-primary py-1 border-r-none w-64 ${className ?? ''}`}
      />
      <button
